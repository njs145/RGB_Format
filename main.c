...
int main(void)
{
    ...
    t_RGB24 buff_rgb24_1byte = {0x68, 0x94, 0x59};
    char *buff_yuv444_1byte;
    char *buff_yuyv422_1byte;
    t_yuv444 *yuv444_buff;

    buff_yuv444_1byte = malloc(sizeof(t_yuv444));
    buff_yuyv422_1byte = malloc(sizeof(t_yuyv422) * 2);
    yuv444_buff = (t_yuv444 *)buff_yuv444_1byte;

    // __uint32_t RGB_DATA = 0xff00;

    // memcpy((t_RGB24* )buff_rgb24_1byte, &RGB_DATA, sizeof(t_RGB24));
    ...
    // YUV_convert_RGB888toYUV444(3, (char *)&buff_rgb24_1byte, buff_yuv444_1byte);
    // YUV_convert_YUV444toYUYV422(4, buff_yuv444_1byte, buff_yuyv422_1byte);


    // printf("yuyv data: 0x%x%x%x%x\n",(t_yuv444 *)yuv444_buff->v, (t_yuv444 *)yuv444_buff->y, (t_yuv444 *)yuv444_buff->u, (t_yuv444 *)yuv444_buff->y );
}